...
import { obtenerAprendicesPorGrupo, obtenerGruposInstructor } from "./asistencia.service";
import {
    ...
    async function cargarAprendices() {
      ...
      try {
        ...
        if (activo) {
          ...
          setMensaje(lista.length ? "" : "No hay aprendices registrados en la ficha seleccionada.");
        }
      } catch (error) {
